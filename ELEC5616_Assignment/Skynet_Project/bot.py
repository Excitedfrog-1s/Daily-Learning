...
from lib.files import download_from_pastebot, filestore, p2p_upload_file
from lib.files import save_valuable, upload_valuables_to_pastebot, valuables
...
def p2p_echo():
    try:
        ...
        while 1:
            ...
            if msg.lower() == 'x' or msg.lower() == "exit" or msg.lower(
            ) == "quit":
                sconn.close()
                break
    except socket.error:
