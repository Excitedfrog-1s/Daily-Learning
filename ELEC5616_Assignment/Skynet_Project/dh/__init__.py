...
def create_dh_key():
    '''
      ...
      returs (public_key, private_key)
      g: Generator that obtained from RFC3526
      Generation method obtained from RFC2631
      '''
    g = 2
...
def calculate_dh_secret(their_public, my_private):
    '''
      Calculate the shared secret, public key * my private % prime
